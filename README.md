...
This repository contains the code and trained weights for the Sound Event Detector and Sound Event Synthesizer models. This README contains instructions for installation, training and inference for both models. 
